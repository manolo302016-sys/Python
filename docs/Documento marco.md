...
## 2.	Requerimientos básicos funcionales de los dashboard entregables ##
## 1 lienzo por tablero en lectura vertical 3000x2000, siguiendo parámetros UX-UI y logica de negocio. Cada dashboard debe ser interactivo y permitir segmentar por las variables de las tablas dimensionales. Los tableros no deben permitir visualizar segmentos de desagregacion donde hayan menos de 5 personas evaluadas. Debe sacar nota de confidencialidad##.
## Tablero 1: dashboard_v1_riesgo##
## N	Seccion	|Descripcion general|Visualizaciones sugeridas 1	Resultados globales y benchmarking	|% en 5 niveles intra A,B, extra A,B, estrés A,B. Total intra+extra A y total intra+extra B.Resultado si tienen que evaluar en 1 año o |Barras apiladas comparativas Gauge/velocímetro de posición resultado empresa en el baremo global intra, extra, estrés por forma A y B KPIs de riesgo consolidados (4 tarjetas)|                 ##
## 2	Resultados globales y benchmarking	|Distribución visual de la cantidad de personas distribuidas de 0 a 100 en el total intra A,B, extra A,B, estrés A,B. Que permita reconocer el nivel superior e inferior y la distribución. Leyenda de cantidad de personas en cada punto de la distribución|Gráficos de dispersión, tipo caja y bigotes de tipo profesional##
## 3	Resultados globales y benchmarking	|% de personas en nivel alto y muy alto intralaboral A y B, comparado con datos de sectores económicos en Colombia. Establecer diferencia (+ o -) en puntos porcentuales y semaforizar|Tabla semaforizada tipo profesional, muestra frecuencias absolutas y relativas. Semaforizar riesgo alto y muy alto >35%, semaforizar si hay diferencia en puntos porcentuales respecto a sector##
## 4	Resultados globales y benchmarking	|% de personas en nivel alto y muy alto por dominios, de forma comparativa con datos de colombia|Barras apiladas comparativas Heatmap de riesgo por dominio##
## 5	Resultados globales y benchmarking	|% de personas en nivel alto y muy alto en dimensiones que se pueden comparar con Datos de Colombia|Tabla semaforizada tipo profesional, muestra frecuencias absolutas y relativas. Semaforizar riesgo alto y muy alto >35%, semaforizar si hay diferencia en puntos porcentuales respecto a colombia##
## 6	Resultados globales y benchmarking	|% de personas en altas frecuencias de respuesta en top de preguntas claves de forma comparada entre empresa y colombia, referenciar diferencia en puntos % semaforizado en lenguaje de riesgo|Tabla semaforizada tipo profesional, muestra frecuencias absolutas y relativas. Semaforizar si hay diferencia en puntos porcentuales respecto a colombia##   
## 7	Resultados empresa vs áreas de trabajo	|% de personas en nivel alto y muy alto en todos los dominios, dimensiones intralaboral A,B, extralaboral A,B y estrés A,B de forma comparada entre áreas y comparado con total de empresa|Heatmap comparativo entre áreas, Radar chart de dominios intralaborales, Bar chart horizontal de subdimensiones ordenadas por score, Boxplot de distribución de scores intra-empresa por área, Tabla ranking de áreas/cargos del nivel de riesgo global. Semaforizar riesgo alto y muy alto >35%, semaforizar si hay diferencia en puntos porcentuales respecto a la empresa. No mostrar datos "no se muestra por confidencialidad" en áreas con menos de 5 trabajadores##
## 8	Resultados empresa vs áreas de trabajo	|% de personas en nivel alto y muy alto en todos los dominios, dimensiones de factores individuales, de forma comparada entre áreas y comparado con total de empresa|Heatmap comparativo entre áreas. Semaforizar riesgo alto y muy alto >35%, semaforizar si hay diferencia en puntos porcentuales respecto a la empresa. No mostrar datos "no se muestra por confidencialidad" en áreas con menos de 5 trabajadores##
